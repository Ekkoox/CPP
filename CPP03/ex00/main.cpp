...
/*   Updated: 2025/10/09 19:07:01 by enschnei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main ()
{
    ...
    ClapTrap ennemi = ClapTrap("Zombie");
    ...
    ennemi.showLifePoints();
    std::cout << BOLD << MAGENTA << "====== Zombie BATTLE PHASE ======" << RESET << std::endl;
    ennemi.attack("Claptrap");
    claptrap.takeDamage(0);
    claptrap.showLifePoints();
    std::cout << BOLD << MAGENTA << "====== ClapTrap REPAIR PHASE ======" << RESET << std::endl;
    claptrap.beRepaired(3);
    std::cout << BOLD << MAGENTA << "====== Zombie REPAIR PHASE ======" << RESET << std::endl;
    ennemi.beRepaired(2);
